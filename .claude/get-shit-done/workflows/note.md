...
- **Global scope**: `/Users/eagle/Downloads/personal-project/Ahmed/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/eagle/Downloads/personal-project/Ahmed/.claude/notes/`)
...
2. Glob `/Users/eagle/Downloads/personal-project/Ahmed/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/eagle/Downloads/personal-project/Ahmed/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/eagle/Downloads/personal-project/Ahmed/.claude/notes/` — works in any directory
