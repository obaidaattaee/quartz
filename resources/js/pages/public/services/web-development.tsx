...
import { Check, Globe, Layers, Rocket, Search } from 'lucide-react';
...
const PROCESS_ICONS = [Search, Layers, Globe, Rocket];
            ...
            <section className="relative bg-primary/5 py-20 dark:bg-primary/10 md:py-28">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <ScrollReveal variant="hero">
                        <Globe size={48} className="mb-4 text-primary" />
                ...
                <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
                    <ScrollReveal>
                        ...
                        <div className="mt-8">
                            ...
                            >
                                <Link
                                    href={`/${locale}/contact?service=web-development`}
                                >
                                    {ctaText}
                                </Link>
                            </Button>
...
WebDevelopment.layout = (page: ReactNode) => (
    <PublicLayout
        breadcrumbs={[
            { title: 'Services', href: '#' },
